...
var Animation = Class(function () {
    ...
    this.loadImages = function () {
        ...
        while (i) {
            ...
            this._images[filename].src = '/code/' + this._project.id + '/' +
                filename;
        }
    };
    this.save = function () {
...
exports = AnimationList = Class(PubSub, function (supr) {
    ...
    this._loadAnimation = function (name) {
        util.ajax.get({
            url: 'code/' + this._project.id + '/resources/animations/' +
                name + '.json',
            type: 'json'
        }, bind(this, 'onLoad'));
    };
    ...
    this.getForFile = function (filename) {
        ...
        this._list.each(function (animation) {
    ...
    this.add = function (animation) {
        ...
        project.manifest.animations.push({
            name: animation.name
        });

...
var ServerSpawner = Class([CuppaProtocol, lib.PubSub], function (supr) {
    ...
    this.frameReceived = function (id, name, args) {
        if ((name == 'RESPONSE' || name == 'ERROR') && this._reqServers[
            args.id]) {
    ...
    this.onCreateServerReq = function (req) {
        ...
        var roomId = req.args.roomId;
        var opts = req.args.options;
...
exports.create = function (transport, transportOpts, appId) {
    ...
    var spawner = new ServerSpawner(transport, std.js.shallowCopy(transportOpts),
        appId);

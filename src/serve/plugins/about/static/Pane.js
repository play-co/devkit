...
var versionData = new squill.models.DataSource({
    key: 'src',
    sorter: function (v) {
        return Version.sorterKey(v.version);
    }
});
exports = Class(sdkPlugin.SDKPlugin, function (supr) {
        ...
        children: [{
            ...
            children: [{
                ...
                children: [{
                        id: 'versionHeader',
                        text: 'all versions:'
                    }, // children: [{tag: 'span', text: 'all versions: '}, {tag: 'span', id: 'aboutVersion'}]},
                    {
    ...
    this.onSwitchVersion = function (version) {
        ...
        util.ajax.get({
            ...
            if (err) {
                ...
                $.setText(this.lastCheckedStatus,
                    'Complete! Reload the page.');
            }
        });
    };
    ...
    this.onVersions = function (err, response) {
        ...
        if (lastChecked == -1) {
            ...
            $.setText(this.lastCheckedStatus, 'last checked ' + string.timeAgo(
                lastChecked));
        }

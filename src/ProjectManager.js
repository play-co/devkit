    ...
    this.loadConfig = function (reload) {
        ...
        var f = ff(this, function () {
            this._projectDirs.forEach(function (dir) {
                ...
                packageManager.getProject(dir, bind(this, function (
                    err, project) {
                    if (err) {
                        logger.error('Game at', dir,
                            'could not be loaded.  Run `basil clean-register` to remove it.'
                        );
                        logger.error('Specific report:',
                            err);
                    } else {

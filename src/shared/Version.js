...
var Version = Class(function () {
    ...
    this.eq = function (version) {
        ...
        return this.major == version.major && this.minor == version.minor &&
            this.patch == version.patch && this.build == version.build &&
    ...
    this.gt = function (version) {
        ...
        return this.major > version.major || (this.major == version.major &&
    ...
    this.toString = function (skipChannel) {
        return [skipChannel ? '' : this.channel, this.major + '.' + this.minor +
            '.' + this.patch, this.build, this.tag].filter(function (v) {
            return v;
        }).join('-');
    };
});
...
Version.sorterKey = function (a) {
    return a.channel + ' ' + pad(a.major) + pad(a.minor) + pad(a.patch) + pad(a
        .build);
}
var LEN = 8;
var MAX = 99999999;
